...
class TestConf(object):
    ...
    def __repr__(self):
        ...
        return fmt % (
            ...
            self.name,
            " ".join(self.args),
            ",".join([" ".join(x) for x in self.to_diff]),
        )
        ...
        try:
            if mode == "gzip":
                ...
                if expected_json["statistics"] == result_json["statistics"]:
                    ...
                    logging.error(
                        "Report file, statistics, %s is different" % (result_path,)
                    )
        except Exception as e:
...
def main():
    ...
    conf = TestConf(
        ...
        args=[
            "--input-fastq-forward",
            os.path.join(path_gold_input, "LENGTHMIN.R1.fastq"),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "LENGTHMIN-A.R1.fastq"), temp_files[0])
        ],
    )
    conf_list.append(conf)
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "LENGTHMIN-B.R1.single.fastq"),
                temp_files[0],
            )
        ],
    )
    ...
    conf = TestConf(
        ...
        args=[
            ...
            os.path.join(path_gold_input, "LENGTHMIN.R1.fastq"),
            "--input-fastq-reverse",
            os.path.join(path_gold_input, "LENGTHMIN.R2.fastq"),
            "--output-fastq-forward",
            temp_files[0],
        ...
        to_diff=[
            (os.path.join(path_gold_input, "LENGTHMIN.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "LENGTHMIN-B.R1.paired.fastq"),
                temp_files[0],
            ),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "LENGTHMIN-A.R1.single.discard.fastq"),
                temp_files[0],
            ),
        ],
    )
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "LENGTHMIN-B.discard.fastq"),
                temp_files[0],
            ),
        ],
    )
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_input, "LENGTHMIN.Interleaved.fastq"),
                temp_files[0],
            )
        ],
    )
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "LENGTHMIN-B.Interleaved.fastq"),
                temp_files[0],
            ),
        ],
    )
    ...
    # ============================================================
    tests = [
        (chr(name), str(thread), "10")
        for name, thread in zip(range(ord("A"), ord("E")), range(2, 10, 2))
    ]
    for test in tests:
        create_tmp_files(TMPFILES, temp_files, 2, ".fastq")
        conf = TestConf(
            ...
            args=[
                "--input-fastq-forward",
                os.path.join(path_gold_input, "BIG.R1.fastq"),
                "--input-fastq-reverse",
                os.path.join(path_gold_input, "BIG.R2.fastq"),
                "--output-fastq-forward",
                temp_files[0],
                "--output-fastq-reverse",
                temp_files[1],
            ...
            to_diff=[
                (os.path.join(path_gold_input, "BIG.R1.fastq"), temp_files[0]),
    ...
    tests = [
        (chr(name), str(thread), "55")
        for name, thread in zip(range(ord("E"), ord("I")), range(2, 10, 2))
    ]
    for test in tests:
        create_tmp_files(TMPFILES, temp_files, 2, ".fastq")
        conf = TestConf(
            ...
            to_diff=[
                (os.path.join(path_gold_output, "BIG-B.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_input, "BIG.R1.fastq.gz"),
                temp_files[0],
                "gzip",
            ),
            (
                os.path.join(path_gold_input, "BIG.R2.fastq.gz"),
                temp_files[1],
                "gzip",
            ),
        ],
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "BIG-B.R1.fastq.gz"),
                temp_files[0],
                "gzip",
            ),
            (
                os.path.join(path_gold_output, "BIG-B.R2.fastq.gz"),
                temp_files[1],
                "gzip",
            ),
        ],
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "LENGTHMIN-C.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        args=[
            "--input-fastq-forward",
            os.path.join(path_gold_input, "QUALSLD.R1.fastq"),
            "--input-fastq-reverse",
            os.path.join(path_gold_input, "QUALSLD.R2.fastq"),
            "--output-fastq-forward",
            temp_files[0],
            "--output-fastq-reverse",
            temp_files[1],
        ...
        to_diff=[
            (os.path.join(path_gold_input, "QUALSLD.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALSLD-A.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALSLD-B.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALSLD-C.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALSLD-D.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALSLD-E.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALSLD-F.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        args=[
            "--input-fastq-forward",
            os.path.join(path_gold_input, "QUALTAIL.R1.fastq"),
            "--input-fastq-reverse",
            os.path.join(path_gold_input, "QUALTAIL.R2.fastq"),
            "--output-fastq-forward",
            temp_files[0],
            "--output-fastq-reverse",
            temp_files[1],
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALTAIL-A.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALTAIL-B.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALTAIL-C.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALTAIL-D.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALTAIL-E.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "QUALTAIL-F.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        args=[
            "--input-fastq-forward",
            os.path.join(path_gold_input, "INFODUST.R1.fastq"),
            "--input-fastq-reverse",
            os.path.join(path_gold_input, "INFODUST.R2.fastq"),
            "--output-fastq-forward",
            temp_files[0],
            "--output-fastq-reverse",
            temp_files[1],
        ...
        to_diff=[
            (os.path.join(path_gold_input, "INFODUST.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "INFODUST-A.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "INFODUST-B.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        args=[
            "--input-fastq-forward",
            os.path.join(path_gold_input, "INFON.R1.fastq"),
            "--input-fastq-reverse",
            os.path.join(path_gold_input, "INFON.R2.fastq"),
            "--output-fastq-forward",
            temp_files[0],
            "--output-fastq-reverse",
            temp_files[1],
        ...
        to_diff=[
            (os.path.join(path_gold_input, "INFON.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "INFON-A.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (os.path.join(path_gold_output, "INFON-B.R1.fastq"), temp_files[0]),
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "ReportFile-A.json"),
                temp_files[2],
                "json",
            ),
        ],
    ...
    conf = TestConf(
        ...
        to_diff=[
            (
                os.path.join(path_gold_output, "ReportFile-B.json"),
                temp_files[2],
                "json",
            ),
        ],
